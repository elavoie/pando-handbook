...
(function(global) {
  ...
  Trainer.prototype = {
    train: function(x, y) {
      ...
      // EL: Commented, seems to work fine anyway
      // if(this.regression && y.constructor !== Array)
      //   console.log("Warning: a regression net requires an array as training output vector. Got a " + typeof y + " of type " + y.constructor.name + " instead.");
