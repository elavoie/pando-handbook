...
* [photo-batch-processing](./examples/photo-batch-processing) - Processing of satellite images using the DAT protocol and the Beaker Browser. This [alternative implementation](./examples/photo-batch-processing-webtorrent) uses [WebTorrent](webtorrent.io) instead of DAT.
